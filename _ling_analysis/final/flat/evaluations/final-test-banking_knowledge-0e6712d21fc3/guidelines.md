...
- When A task that has a 'signature' of official_task_failure and results in an empty conversation after 50 turns, indicating a stuck or infinite loop.: The agent must detect this pattern and reset the task or seek clarification.
