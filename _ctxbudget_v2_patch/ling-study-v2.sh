...
exec /home/yangfan/meta-agent-test/.venv/bin/python -u -m experiments_tau3_mmh_study.supervise_study --repo "$REPO" --root /home/yangfan/mmh-exp/full375-20260916-v2 --label ling
